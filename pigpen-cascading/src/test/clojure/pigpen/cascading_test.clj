...
(deftest test-performance
  (let [fields (Fields. (into-array ["value"]))
        context (pigpen.runtime/exec [(pigpen.runtime/process->bind (pigpen.runtime/pre-process :cascading :frozen))
        ...
        call (reify FunctionCall
               ...
               (getOutputCollector [this]
                 (proxy [TupleEntryCollector] [fields]
                   (collect [tuple]))))
        udf (PigPenFunction. nil nil fields)
